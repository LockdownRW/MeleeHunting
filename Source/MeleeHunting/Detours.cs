...
{
    //class borrowed from CCL to avoid dependency
    ...
    public static class Detours
    {
        ...
        **/
        public static unsafe bool TryDetourFromTo(MethodInfo source, MethodInfo destination)
        {
            ...
            if (source == null)
            {
                Log.Error(typeof(Detours).Namespace + " detours - Source MethodInfo is null");
                return false;
            }

            if (destination == null)
            {
                Log.Error(typeof(Detours).Namespace + " detours - Destination MethodInfo is null");
                return false;
            }
